...
var Dispatcher = function(options) {
  ...
  if (this.options.console)
    this.useAdapter(this.adapters.console());
  if (this.options.filter) {
    this.filter(this.options.filter);
  }
};

Dispatcher.prototype.adapters = require('./adapters');
...
Dispatcher.prototype.useAdapter = function(f, level, moduleName, section) {
  var self = this;
...
Dispatcher.prototype.removeAdapters = function() { 
