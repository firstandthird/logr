...
Core.prototype.getEventName = function(name, section, level) {
  if (!name) name = '*';
  if (!section) section = '*';
  if (!level) section = '*';
...
Core.prototype.useAdaptor = function(f, level, moduleName, section) {
  var self = this;
...
Core.prototype.emit = function(module, section, level, message, data) {
